...
@class HXJCalendarDateModel;

typedef void(^CalendarDetermineBtnSelectBlock)(NSMutableArray *selectDatesArrM);



#pragma mark - 日历类
@interface HXJCalendarView : UIView

//不传，默认蓝色
@property(nonatomic,strong)UIColor *selectColor;

//已选中的日期,传入，就会显示已经选中的
@property(nonatomic,strong)NSMutableArray *selectDatesArrM;

//点击确定返回block
@property(nonatomic,copy)CalendarDetermineBtnSelectBlock selectBlock;
...
@interface HXJCalendarCollectionViewCell : UICollectionViewCell

//日历模型
@property(nonatomic,strong)HXJCalendarDateModel *dateModel;
//不传，默认蓝色
@property(nonatomic,strong)UIColor *selectColor;
...
#pragma mark - 日历模型类
@interface HXJCalendarDateModel : NSObject
//=============数据
